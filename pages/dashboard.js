...
const cards = [
  ...
  { name: 'Bruce springsteen', href: 'https://guess-that-song.vercel.app/?id=37i9dQZF1DZ06evO1S7maQ', icon: MusicNoteIcon, amount: 'Can you be as successful as this girl band? ' } 
  // More items...
]
// recently activity
const playlists = [
